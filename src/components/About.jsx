                    ...
                    <div className="p-2">
                        <div className="text-gray-300 my-3">
                            <p className="text-justify leading-7 w-11/12 mx-auto">
                                Hello, I'm final year student in Computer Science and Engineering. I always look towards obtaining a
                                challenging and competitive environment.A Fast Learner with Strong Time Management and Multitasking
                            ...
                            <br />
                            <br />
                            <a href="./src/assets/mycv.pdf" download>
